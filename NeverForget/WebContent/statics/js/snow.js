...
(function(){
		...
		//创建函数的一种方式,prototype为其指代的Snow对象
		Snow.prototype.init=function(){
			console.log("背景区域",this.box)
			...
			for(var i=0;i<this.size;i++){//创建好雪花
				...
				snow.style.cssText='position:absolute;color:white;';//符号对象颜色
				snow.style['font-size']=snowSize+'px';
				snow.style.left=left+'px';
				snow.style.top=top+'px';
				snow.innerHTML='&#10052'; //HTML5特殊符号编码
				this.item.push(snow);
	 ...
	 //创建Snow对象,在创建的时候prototype的属性也会跟着初始化
		new Snow(300,30);
	})()
